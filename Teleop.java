...
public class Teleop extends OpMode
{
    ...
    private DcMotor lb, lf, rb, rf, arm,launcher1, intake;
    ...
    public void loop() {
        ...
        launcher2power   = Range.clip(l2p, 2300, 3000) ;
        ...
        {
            //slowlaunch(100);
            launcher2.setVelocity(-launcher2power);
        ...
        else if(gamepad2.dpad_up)
        {
            ...
            //slowlaunch(200);
            launcher2.setVelocity(-1800);
        }
        else if(gamepad1.b)
        {
            launcher2.setVelocity(-5000);
        }
        else if (gamepad2.dpad_down)
        {
            //slowlaunch2(-100);
            if (launcher2.getVelocity()<-200)
            {
                launcher2.setVelocity(launcher2.getVelocity()*.99);
            }
            else
            {
                launcher2.setVelocity(500);
            }
        }
        else{
        ...
        //    intake.setPower(0);
        //}
        launcher1.setPower(-launcher1power);
        //else
        //{
        //    grab.setPosition(1);
        //}
    ...
    public void slowlaunch(int current)
    {
        while (launcher2.getVelocity()>current)
        {
            launcher2.setVelocity(launcher2.getVelocity() * .75);
        }
    }
    public void slowlaunch2(int current)
    {
        while (launcher2.getVelocity()<current)
        {
            launcher2.setVelocity(launcher2.getVelocity()*.99);
