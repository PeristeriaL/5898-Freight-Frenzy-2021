 ...
 */
@Autonomous(name = "Cam red right speed new", group = "Red")
@Disabled
public class RedRightSpeed extends LinearOpMode {
  ...
  public void runOpMode() {
   ...
   // rotate.setDirection(DcMotor.Direction.REVERSE);
    ...
    if (opModeIsActive()) {
      ...
      int level = 0; // variable to change what level thanos goes to
  ...
  public void angleTurnRight(int amtF, double powerD) {
    ...
    while (opModeIsActive() && (rb.isBusy() && rf.isBusy() && lb.isBusy() && lf.isBusy())) {
      rb.setPower(powerD/4);
      lf.setPower(powerD/6);
      rf.setPower(powerD);
      lb.setPower(powerD);
  ...
  public void angleTurnRightMid(int amtF, double powerD, double powerUp) {
    rf.setTargetPosition(rf.getCurrentPosition() + amtF);
    rb.setTargetPosition(rb.getCurrentPosition() + amtF);
    lf.setTargetPosition(lf.getCurrentPosition() - amtF);
    lb.setTargetPosition(lb.getCurrentPosition() + amtF);
    
    screw.setTargetPosition(screw.getCurrentPosition() - 1500);
    ...
    while (opModeIsActive() && (rb.isBusy() && rf.isBusy() && lb.isBusy() && lf.isBusy() && screw.isBusy())) {
      rb.setPower(powerD);
      lf.setPower(powerD);
      rf.setPower(powerD/4);
      lb.setPower(powerD/6);
      
      screw.setPower(powerUp);
