 ...
 */
@Autonomous(name="Red Left Duck wheel Warehouse", group="Red")

public class RedLeftDuckWheel extends LinearOpMode {
...
////// movement methods ////////////////////////////////////////////////////////
    ...
    public void deliverDuck(){
        forwardAmt(150,.6);
        rightAmt(1100,.4);//rotate for duuuck wheeeel
        backAmt(830,.4);//back up to duck wheeeeel
        
        spin.setPower(-.4); //spiiiiiiiiiin
        sleep(2500);
        spin.setPower(0);
        
        forwardAmt(830,.4); //go forward off of wheeeeeel
        rightAmt(-1100,.4); //rotate to be back at start
    }
