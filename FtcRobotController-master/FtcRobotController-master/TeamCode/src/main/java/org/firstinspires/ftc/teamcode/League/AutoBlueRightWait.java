 ...
 */
@Autonomous(name = "Cam Blue Right Wait 5", group = "Blue")

public class AutoBlueRightWait extends LinearOpMode {
  ...
  public void mid() {
    ...
    strafe(-1300, .4); // strafe to the goal
    
    up(1500, .6); // go up

    forwardAmt(800, .55); // approach goal
